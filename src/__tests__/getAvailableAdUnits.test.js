...
import getAvailableAdUnits, { getAdUnitConfig } from 'src/getAvailableAdUnits'

describe('getAdUnitConfig', () => {
  it('exports the expected ad units config', () => {
    const expectedVal = {
      leaderboard: {
    ...
    expect(getAdUnitConfig()).toEqual(expectedVal)
  })
})
